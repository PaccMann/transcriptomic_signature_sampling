...
TARGET=${1:-"cms"}
CV_SPLITS_PATH=${2:-"/Users/nja/Desktop/Sinergia/data/tinder_expts/5x5stratified_20percent/cv_splits_strat.json"}
OUTPUT_DIR=${3:-"/Users/nja/Desktop/Sinergia/data/tinder_expts/5x5stratified_20percent"}
    ...
    do
        for class_size in max 500 5000
            do
                ...
                --ref_df_path "/Users/nja/Desktop/Sinergia/data/tinder_expts/tcga_colotype_gex_counts.csv" \
                --ref_labels_path "/Users/nja/Desktop/Sinergia/data/tinder_expts/tcga_colotype_gex_labels.csv"\

...
## Data Availability
For reproducibility purposes, we provide the *standardised augmented datasets* and corresponding *standardised test datasets* [here](https://ibm.box.com/v/signature-sampling-data).
